...
import app.jurisdiction.Jurisdiction_;
import app.servicedefinition.ServiceDefinition_;
...
public interface ServiceRequestRepository extends PageableRepository<ServiceRequest, Long>,
    ...
    class Specifications {
        ...
        public static QuerySpecification<ServiceRequest> serviceCodeIn(List<Long> serviceCodes) {
            return (root, query, criteriaBuilder) -> root.get(ServiceRequest_.service).get(ServiceDefinition_.id).in(serviceCodes);
        }
