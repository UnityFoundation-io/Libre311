...
@Introspected
public class ServiceRequestPostRequest implements RecaptchaRequest {
   private static final Logger LOG = LoggerFactory.getLogger(ServiceRequestPostRequest.class);
    ...
    public ServiceRequestPostRequest(Long serviceCode) {
