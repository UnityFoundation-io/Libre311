...
<div class="relative">
	...
	<div class="relative">
		<select
			...
			{disabled}
			class="appearance-none bg-white text-gray-900 focus:border-blue-500 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-100 {compact
				? 'rounded-full border border-gray-300 py-2 pl-4 pr-10 text-base'
				: 'w-full rounded-md border border-gray-300 py-2 pl-3 pr-10 text-sm'} {className}"
		>
