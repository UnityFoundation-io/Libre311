...
<div class="flex flex-col gap-4 border-t border-gray-200 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:py-3">
	...
	<div class="flex flex-wrap items-center gap-x-4 gap-y-3 sm:gap-2">
		<div class="flex items-center gap-2">
			<button
				type="button"
				class="flex items-center gap-1 rounded px-2 py-1.5 text-sm text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 sm:py-1"
			...
			<button
				type="button"
				class="flex items-center gap-1 rounded px-2 py-1.5 text-sm text-red-600 hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500 sm:py-1"
